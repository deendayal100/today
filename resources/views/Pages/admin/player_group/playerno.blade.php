...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 col-12 align-self-center">
            <h4 class="text-themecolor mb-0">Number of Players</h4>
        </div>
        <div class="col-md-7 col-12 align-self-center d-none d-md-block">
            <ol class="breadcrumb mb-0 p-0 bg-transparent fa-pull-right">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Number of Players</li>
            </ol>
        </div>
    </div>
    <!-- ============================================================== -->
            ...
            <form>
                <div class="card">
                    <div class="border-bottom title-part-padding d-flex justify-content-between">
                        <h4 class="card-title mb-0">Number of Players</h4>
                    </div>
                        ...
                        <div>
							@if($ante_amount != '' && $ante_amount != null)
								...
								<div class="row g-3 align-items-center">
									<div class="col-6">
										<label for="exampleInputEmail1" class="form-label">Number of Players First</label>
								...
								<div class="row g-3 align-items-center">	
									<div class="col-6">
										<label for="exampleInputPassword2" class="form-label">Number of Players Second</label>
										<input type="text" class="form-control" id="anteInput2" value="{{$ante_amount[1]}}">
									</div>
								</div>
								<div class="row g-3 align-items-center">	
									<div class="col-6">
										<label for="exampleInputPassword3" class="form-label">Number of Players Third</label>
        ...
        $.ajax({
			...
			success: function(data) {
                ...
                if(obj.status==true){
					...
					setTimeout(function(){
						 window.location.href = "group-player-no";
					},2000);
				}else{
