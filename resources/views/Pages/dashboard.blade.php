            ...
            <div class="container-fluid" >
                <div class="card-group" style="display:">
                    ...
                    <div class="card" style="display:">
                        <div class="card-body text-center">
                            <h4 class="text-center">Total Players</h4>
                            <div class="d-flex justify-content-center mt-3">
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            <h4 class="text-center">Total Game Played</h4>
                            <div class="d-flex justify-content-center mt-3">
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            <h4 class="text-center">Total Funds</h4>
                            <div class="d-flex justify-content-center mt-3">
                                <div id="page-views" style="width: 120px"></div>
                            </div>
                        </div>
                        <div class="p-2 rounded border-top text-center">
                            <h4 class="font-medium mb-0"><i class="ti-angle-up text-success"></i> {{$total_service}}</h4>
                        </div>
                    </div>
                    <!-- Column -->
