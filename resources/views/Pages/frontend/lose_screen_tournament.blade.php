            ...
            <div class="play_btns_area">
               <button type="button" class="play_btn">
                ...
                <div class="yes_no_btn">
                    <a href="{{url('/tournament-ante')}}"><button type="button" class="yes_btn">Yes</button></a>
                    <a href="{{url('/player-account')}}"><button type="button" class="no_btn">No</button></a>
                </div>
            </div>
            <div class="play_bonus_btn_area">
                <button type="button" class="play_bonus_btn">
                    Bonus Pot stands at $@if(isset($bonuspot)){{$bonuspot}}@endif
                </button>
            </div>
        </div>
    </div>
