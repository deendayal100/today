...
<div class="witget_body bg_1 text-center">
    ...
    <div class="nav_area_box">
        ...
        <ul>
            ...
            <li>
            <a href="#"><span class="nav_list_icon"><img src="{{ asset('assets/frontend/images/icons/stats.png') }}" width="14" alt="icon"/></span> Player Game History</a>
            </li>
            <li>
    ...
    <div class="player_account_area">
        <div class="player_account_top">
            @if(!empty($player_info))
            <div class="name_image" style="background: none;"><img src="{{$player_info->image}}" alt="img" id="img_preview"/></div>
        ...
        <div class="player_account_links">
            ...
            <img class="account_links_left_icon" src="{{ asset('assets/frontend/images/icons/user-icon-2.png') }}" width="14" alt="img">
            Player Profile
            <img class="account_links_right_icon" src="{{ asset('assets/frontend/images/icons/arrow-right-2.png') }}" width="8" alt="img">
            </button></a>
            <a href="{{route('player-fund-management')}}"><button type="button" class="account_links">
            <img class="account_links_left_icon" src="{{ asset('assets/frontend/images/icons/user-icon-3.png') }}" width="19" alt="img">
            Player Fund Management
            <img class="account_links_right_icon" src="{{ asset('assets/frontend/images/icons/arrow-right-2.png') }}" width="8" alt="img">
            </button></a>
            <a href="{{route('player-game-history')}}"><button type="button" class="account_links">
            <img class="account_links_left_icon" src="{{ asset('assets/frontend/images/icons/stats.png') }}" width="14" alt="img">
            Player Game History
            <img class="account_links_right_icon" src="{{ asset('assets/frontend/images/icons/arrow-right-2.png') }}" width="8" alt="img">
            </button></a>
        </div>
        ...
        <div class="player_account_btn_area">
            ...
            <a href="{{route('tournament-ante')}}"><button type="button" class="tournament_btn">PLAY IN THE HOURLY TOURNAMENT</button></a>
        </div>
    </div>
</div>
@stop